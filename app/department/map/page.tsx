...
export default function DepartmentMapPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] text-center">
      ...
      >
        <MapPin className="w-16 h-16 text-blue-500/50 mx-auto mb-4" />
        <h1 className="text-2xl font-bold text-white mb-2">Live Map</h1>
        <p className="text-neutral-400 max-w-md mx-auto mb-6">
          The department-specific map layer is syncing with the global Geo-Intelligence map.
        </p>
