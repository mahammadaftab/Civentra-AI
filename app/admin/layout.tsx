import { AdminSidebar } from "@/app/components/features/dashboard/AdminSidebar";
...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-neutral-950 text-neutral-200 selection:bg-red-500/30">
      <AdminSidebar />
